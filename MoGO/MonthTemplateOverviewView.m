    ...
    if (self) {
        ...
        for (int i=0; i<6; i++) {
            for (int j=0; j<7; j++) {
                ...
                //Split the whole Canvas to tiles with a seize of 40px, with a border of 1 px between the tiles
                ...
                //A day is not active if it is before the first Day of the Week
                ...
                NSLog([NSString stringWithFormat:@"%d",status]);
                NSLog([NSString stringWithFormat:@"%d",actualDay]);
